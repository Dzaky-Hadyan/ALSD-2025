...
public class DosenDemo07 {
    public static void main(String[] args) {
        ...
        Dosen07 d3 = new Dosen07("003", "beta", false, 20);
        ...
        do {
            ...
            System.out.println("5. Cari data sequential");
            System.out.println("6. Cari data binary");
            ...
            switch (menu) {
                ...
                case 5:
                    ...
                    list.tampilDataSearch(cariNama, list.PencarianDataSequential07(cariNama), 0);
                    break;
                ...
                case 6:
                    ...
                    cariUsia = sc.nextInt();
                    list.sortingASC();
                    list.tampilDataSearch(null, list.PencarianDataBinary07(cariUsia, 0, list.dataDosen.length - 1), cariUsia);
                    break;
            }
        } while (menu != 0);
        sc.close();
